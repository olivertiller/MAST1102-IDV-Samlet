...
Produkter kan analyseres ut fra variasjon, volum, etterspørselsmønster og lagringsbehov. Høy variantbredde øker kompleksiteten i produksjon og lagerstyring, særlig når etterspørselen er sesongpreget \parencite{strandhagen2024}. \textcite{slack2019} klassifiserer produksjonsprosesser etter forholdet mellom volum og produktvariasjon, fra prosjektbasert produksjon via stykk- og serieproduksjon til masse- og kontinuerlig produksjon. Plasseringen i denne matrisen gir føringer for valg av layout og styringsform.

\subsection{Analyse av Kviles markedssegmentering}
Kvile AS (heretter bare Kvile) produserer robuste møbler til utendørs bruk. Møblene produseres i Orkanger, Trøndelag, og distribueres til hele Norge. Denne seksjonen analyserer Kviles marked, kundesegmenter, produktmiks og etterspørselsmønster. Caset tar utgangspunkt i situasjonen per 1.\ november 2024.

\textbf{Kundegruppen}\\
Selskapet har tre store kunder: Statens Vegvesen, Plantasjen og Møbelringen. Vegvesenet er den største kunden målt i omsetning med 125 millioner kroner i årlig salgsvolum, mot 75 millioner til Plantasjen og Møbelringen. Vegvesenet står dermed for ca.\ 63\,\% av omsetningen, selv om antall enheter er likt (omtrent 15\,000 møbler til begge grupper). Dette viser at varer solgt til Vegvesenet har betydelig høyere inntekt per levert enhet enn butikksegmentet: 8\,333 kr per møbel (inkl.\ transport og montering på rasteplass) mot 5\,000 NOK for butikkene.
