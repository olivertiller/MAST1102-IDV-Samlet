...
Innenfor lagernivåstyrt produksjon skilles det videre mellom trykk- og sugsystemer. I et trykksystem (push) styres produksjonen av prognoser og planer som ``trykker'' materialer gjennom verdikjeden, mens et sugsystem (pull) lar faktisk forbruk nedstrøms utløse påfyll fra foregående steg \parencite{strandhagen2024}. En konkret pull-mekanisme er \textit{Kanban}, der et signal fra en nedstrøms stasjon utløser påfyll oppstrøms, slik at varer i arbeid (VIA) holdes på et minimum. Valg av styringsprinsipp henger tett sammen med omstillingstider: lange omstillingstider favoriserer store serier og lavere frekvens, mens korte omstillingstider muliggjør mindre batcher og hyppigere produksjonsskifter.

Lean-filosofien identifiserer syv former for sløsing (\textit{muda}), blant annet overproduksjon, unødvendig lager, venting og transport \parencite{strandhagen2024}. MRP er et push-basert verktøy for å beregne komponentbehov ut fra produksjonsplan, produktstruktur og lagerbeholdning \parencite{strandhagen2024}.
...
MTS-styringen for butikkmarkedet er derimot utfordrende av tre grunner. For det første medfører 304 varianter på ferdigvarelager betydelig kapitalbinding og risiko for fargekombinasjoner med lavt salg. For det andre forsterker sesongsvingningene problemet: 50\,\% av salget skjer i mai--juli, noe som krever enten stor lageroppbygging i forkant eller kraftig kapasitetsøkning i produksjonen om våren. For det tredje vokser variantantallet med 96 nye SKU-er for hver ny modell som lanseres, noe som gjør lagerstyringen stadig mer kompleks.
...
Effekten på lagerkompleksiteten er betydelig. Tabell~\ref{tab:ato-sammenligning} viser hvordan antall lagervarer reduseres ved en overgang fra MTS til ATO.
...
Beregningen er en forenkling, ettersom faktisk antall komponent-SKU-er avhenger av hvordan delsett defineres og hvor standardiserte komponentene er på tvers av modellene. Likevel illustrerer den hovedpoenget: ved å lagre komponenter fremfor ferdig monterte fargekombinasjoner reduseres lagerkompleksiteten betydelig.

ATO-modellen åpner også for å styre komponentlageret med \textit{Kanban}: når montasjen forbruker en beholder med f.eks.\ blå aluminiumsrammer, sendes et påfyllsignal tilbake til lakkhallen. Slik går man fra ren push til et hybrid push/pull-system der produksjon av halvfabrikata fortsatt planlegges med MRP (faste seriestørrelser er naturlig gitt omstillingstiden på lakkanleggene), mens sluttmontasjen trekkes av faktiske kundeordrer. Dette reduserer særlig ferdigvarelager, overproduksjon av svake fargekombinasjoner og kapitalbinding.

En overgang til ATO forutsetter likevel at sluttmontasjen har tilstrekkelig kapasitet i høysesongen. Lagerproblemet fjernes heller ikke fullstendig, men flyttes fra ferdigvarer til halvfabrikata. Dersom etterspørselen etter enkelte farger blir svært skjev, kan Kvile fortsatt få ubalanse i komponentlageret. ATO bør derfor kombineres med sesongjusterte minimums- og maksimumsnivåer for komponenter, samt løpende analyse av hvilke fargekombinasjoner som faktisk selger.

ATO bør suppleres med syklisk styring av lakkanleggene og økt komponentstandardisering på tvers av modellene. I tillegg bør Kvile bruke salgsdata til å redusere farger med lav omløpshastighet, dersom dette ikke svekker kundeverdien vesentlig.
