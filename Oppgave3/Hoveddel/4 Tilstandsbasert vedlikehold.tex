...
Redundans innebærer at en ekstra komponent legges til for å sikre systemfunksjonen dersom den primære komponenten feiler \parencite{pedersen_redundans}. I beregningene antas redundansen å kunne modelleres som en ideell parallellkobling, der systemfunksjonen opprettholdes så lenge minst én av de parallelle komponentene fungerer. Eventuelle innkoblingsfeil, fellesfeil og praktiske begrensninger er ikke inkludert \parencite{pedersen_redundans}.

Det er viktig å skille mellom pålitelighet og tilgjengelighet. Pålitelighet beskriver sannsynligheten for feilfri drift over en periode, mens tilgjengelighet beskriver hvor stor andel av tiden systemet faktisk er operativt, og avhenger også av reparasjonstid. Mean Time To Repair (MTTR) er forventet reparasjonstid etter feil for en enkelt komponent. Selv om MTTR ikke inngår direkte i beregningen av systempålitelighet, er verdien relevant ved vurdering av konsekvensene av feil.
...
Alle tre komponentene parallellkobles med en redundant komponent, altså full redundans. Dette gir den høyeste beregnede påliteligheten til kompressortoget, på 98\%. Redundansen kan også muliggjøre utføring av vedlikehold på enkeltkomponenter uten full stans i kompressortoget.

Det må vurderes om den økte påliteligheten veier opp for de ekstra kostnadene ved å doble antall komponenter, samt om begrensninger på plattformen som plass, vekt og risiko for fellesfeil (for eksempel felles strømforsyning eller kontrollsystem) tillater dette inngrepet.

\textbf{\large Forslag 2 - Prioritere pålitelighet} 

Andretrinns kompressoren og elmotoren parallellkobles med tilsvarende redundante komponenter. Dette gir den høyeste påliteligheten til kompressortoget ved totalt fem komponenter, på 93\%. Førstetrinns kompressor har fortsatt MTTR på 40 timer, noe som innebærer at en feil i denne komponenten kan gi lengre nedetid. Sammenlignet med forslag 1 er forslag 2 billigere, tar mindre plass og veier mindre.

\textbf{\large Forslag 3 - Prioritere MTTR}

Begge kompressorene parallellkobles med redundante kompressorer. Systempåliteligheten er lavere enn i forslag 2, på 88\%, men redundansen på kompressorene gjør at en feil i én kompressor ikke nødvendigvis fører til umiddelbar stans. Den gjenværende flaskehalsen for reparasjonstid blir da elmotoren med MTTR på 4 timer. Her må det vurderes om tapet på 5 prosentpoeng i pålitelighet veies opp av redusert konsekvens ved kompressorfeil.

\section{Konklusjon}

Systempåliteligheten til kompressortoget kan økes betydelig ved parallellkobling av redundante komponenter. Dersom målet utelukkende er høyest systempålitelighet, er full redundans det beste alternativet, med beregnet pålitelighet på 97{,}56\%. Dersom kostnad, plass og vekt vektlegges, fremstår redundans på andretrinns kompressor og elmotor som et mer balansert tiltak, siden dette øker systempåliteligheten fra 76{,}10\% til 92{,}91\% uten å doble hele kompressortoget. Redundans på begge kompressorene kan være aktuelt dersom hovedmålet er å redusere konsekvensen av lang reparasjonstid, men dette gir lavere beregnet pålitelighet enn alternativet med redundans på andretrinns kompressor og elmotor. Beregningene er basert på idealiserte forutsetninger om uavhengige og identiske komponenter, og en fullstendig vurdering bør også inkludere praktiske begrensninger og økonomiske analyser.
