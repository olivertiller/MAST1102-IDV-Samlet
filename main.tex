...
% \part produserer ingen synlig overskrift, men skriver scoping-markører
% til .toc, .lof og .lot slik at \localtableofcontents m.fl. fungerer.
\makeatletter
...
\newcommand{\reportstart}{%
  \part{}% Usynlig scope-grense for etoc
