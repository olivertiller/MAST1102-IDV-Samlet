...
KI-verktøy ble brukt som støtte i arbeidet med den samlede innleveringen, på tre måter.

For det første ble KI brukt i en rådgivende rolle under arbeidet med rapportene, blant annet til å identifisere områder der besvarelsene kunne styrkes opp mot oppgaveteksten. Vurderingene og det faglige innholdet er vårt eget.

For det andre ble KI brukt i skriveprosessen til rettskriving, omformulering av setninger og forslag til klarere tekststruktur.

For det tredje ble KI brukt til teknisk oppsett av det samlede LaTeX-dokumentet, herunder sammenstilling av fem selvstendige rapporter i én fil med separate innholdsfortegnelser, referanselister og seksjonsnummerering per rapport.
