...
Det ble ikke gjennomført målinger for alle tilgjengelige nålposisjoner, og det er derfor mulig at en annen nålposisjon kan gi høyere virkningsgrad enn nålposisjon 3. Videre arbeid bør inkludere testing av alle nålposisjoner for å identifisere optimal drift.

\subsection{Praktisk nytte av virkningsgradsmålinger}

Den praktiske nytteverdien av å kjenne virkningsgraden er at den kan brukes til å vurdere om turbinen arbeider nær sitt optimale driftspunkt. Dersom virkningsgraden reduseres over tid ved samme vannføring, trykk og belastning, kan det indikere økte tap i systemet. Dette kan skyldes slitasje på skovler, feiljustert dyse, økt friksjon, lekkasjer eller problemer med bremsing og lager. Virkningsgraden kan derfor brukes som en enkel indikator på turbinens tekniske tilstand og som støtte for drift og vedlikehold.

Ved å kartlegge virkningsgraden over tid kan man identifisere endringer i turbinens ytelse ved å sammenligne med tidligere målinger. Nivået og utviklingen i virkningsgraden kan dermed brukes som grunnlag for beslutninger knyttet til drift og vedlikehold.
